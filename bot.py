...
# True  = Mittwoch + Donnerstag werden sofort getestet.

# False = Normalbetrieb nach Wochentag.
...
# Bonus nur bei echten Reward-/Multiplikator-Hinweisen.
bonus_patterns = [
    r"\b2x\b",
    r"\b3x\b",
    r"\b4x\b",
...
# Fahrzeuge nur bei konkreten Fahrzeug-Hinweisen.
vehicle_patterns = [
    r"\bnew vehicle\b",
    r"\bnew car\b",
    r"\bnew supercar\b",
...
# Im TEST_MODE wird bewusst IMMER gesendet.
send_discord(
    message
)
...
# Im Testmodus wird der Beitrag immer gesendet.
if TEST_MODE and not categories:
    categories = [
        "🆕 **NEU**\n"
        "Testmeldung für den Geheimbericht."
    ]
...
print(
    "Es werden Mittwoch und Donnerstag getestet."
)

print(
    "weekly_state.json wird NICHT verändert."
)
